...
def get_value(params, prev):
    #return  [a * prev[0] - 0.000001 * b * prev[1] * prev[0], c * prev[1] - 0.001 * d * prev[1] * prev[0] ]
    a,b,c,d = params
    return  [a * prev[0] -   b *  prev[1], c * prev[1] -  d *  prev[0] ]
...
#OPTIMIZATION
#
initial_guess = [1.1, 0.8, 1.4, 0.0005]

#BB, impact of Netflix to BB, NFLX
bounds = ((0.93, 1.2), (0.9, 3), (0.4, 2.1), (0, 1))
